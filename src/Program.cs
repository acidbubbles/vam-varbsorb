...
namespace Varbsorb
{
    public class Program
    {
        ...
        /// <param name="filter">Filter which scenes will be affected. You can specify partial paths.</param>
        ...
        private static async Task<int> Main(string vam, string[]? filter = null, bool verbose = false, bool warnings = false, bool noop = false)
        {
            var container = Configure();
            var runtime = container.Resolve<Varbsorber>();
            try
            {
                await runtime.ExecuteAsync(vam, filter, verbose, warnings, noop);
                return 0;
            }
        ...
        private static IContainer Configure()
        {
            ...
            builder.RegisterType<ListUnusedFilesOperation>().As<IListUnusedFilesOperation>();
